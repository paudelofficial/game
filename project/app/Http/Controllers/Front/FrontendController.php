...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $products =  Product::with('user')->where('status','=',1)->select($selectable)->orderBy('id','desc')->take(8)->get()->reject(function($item){
	    ...
	    return view('front.index',compact('ps','sliders','top_small_banners','feature_products','products'));
	}
