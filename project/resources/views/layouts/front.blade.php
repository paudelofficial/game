...
@endif
	...
	<section class="logo-header">
		<div class="container">
			<div class="row ">
				...
				<div class="col-lg-2 col-sm-6 col-7 remove-padding order-lg-last" style="font-size:14px;">
                    <div class="list"  style="margin-top:1em;text-align:right;">
                        <ul>
                            @if(!Auth::guard('web')->check())
                            <li class="login">
                                <a href="#" class="sign-log" data-toggle="modal" data-target="#loginModal">
                                    <div class="links">
	...
	<!--Main-Menu Area Start-->
     <div class="mainmenu-area mainmenu-bb">
		<div class="container">
			<div class="row align-items-center mainmenu-area-innner" style="padding:0.4em 0;">
				<div class="col-lg-10 col-md-12 mainmenu-wrapper remove-padding">
                    <nav class="navbar navbar-expand-lg">
                        <div class="nav-header">
                            <button class="toggle-bar" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation"><span class="fa fa-bars"></span></button>
                        </div>
                        
                        <div class="collapse navbar-collapse navbar-padding" id="navbarNavDropdown" style="background:white;">
                            <ul class="nav navbar-nav">
                            @foreach($categories as $category)
                                <li class="{{count($category->subs) > 0 ? 'dropdown mydropdowncss':''}} {{ $loop->index >= 14 ? 'rx-child' : '' }}" style="margin-right:1em;">
                                @if(count($category->subs) > 0)
                                    <div class="link-area">
                                        <span><a href="{{ route('front.category',$category->slug) }}" class="dropdown-toggle" data-toggle="dropdown">{{ $category->name }}</a></span>
                                    </div>
                                @else
                ...
                <div class="col-lg-2 col-sm-6 col-7 remove-padding order-lg-last">
                    <div class="helpful-links">
                        <ul class="helpful-links-inner row">
	...
	<div class="modal fade bs-example-modal-lg" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content" style="padding:1em 0.5em">
                <div class="row">
                    <div class="col-lg-6" style="padding:3em">
                          <div class="modal-banner-content">
                              <div class="modal-banner-title">
                                <h3 style="text-align:center">Welcome To NDMGamers.com</h3>
                              </div>
                    ...
                    <div class="col-lg-6">
                        <div class="modal-header">
                          ...
                          {{-- <h4 class="modal-title" id="myModalLabel">SignIn/Register</h4>  --}}
                        </div>
                                  ...
                                  <div class="login-area">
                                    ...
                                    <div class="login-form signin-form">
                                      ...
                                      <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                        ...
                                        <div class="form-forgot-pass" style="align-items:center">
                                          <div class="left">
                                        ...
                                        <div class="social-area">
                                          <h4 class="title">{{ $langg->lang179 }}</h4>
...
@yield('content')
	...
	<footer class="footer" id="footer">
		<div class="container">
			<div class="row" style="padding: 0 0 2.5em 0;">
                <div class="col-lg-3">
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list">
							@foreach($categories as $category)
							<li>
								<a href="{{ route('front.category',$category->slug) }}"><i class="fas fa-angle-double-right"></i>{{ $category->name }}</a>
							</li>
							@endforeach
						</ul>
					</div>
		...
		<div class="payement-bg" style="background: white;padding: 0.5em;margin-bottom: -2.2em;">
			<div class="container">
				<div class="row">
					<img src="{{asset('assets/images/esewa.png')}}" alt="" style="width:115px;margin:0 0.5em;transform:scale(0.7);">
					<img src="{{asset('assets/images/khalti.png')}}" alt="" style="width:80px;margin:0 0.5em">
				</div>
			</div>
		</div>
							...
							<div class="content row">
                                <div class="footer-logo">
                                    <a href="{{ route('front.index') }}" class="logo-link">
                                        <img src="{{asset('assets/images/'.$gs->footer_logo)}}" alt="" style="width:100px;">
                                    </a>
                                </div>
								<div class="content">
									<p style="margin-top:0.5em; margin-left:2em">{!! $gs->copyright !!}</p>
								</div>
							</div>
						</div>
					</div>
